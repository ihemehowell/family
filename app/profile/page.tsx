  ...
  return (
    <div className="max-w-3xl mx-auto p-4 space-y-3">
      <div className="flex justify-between items-center">
        ...
        <Link href="/dashboard" className="text-sm text-black hover:text-gray-700 flex items-center justify-center  gap-2 transition">
      ...
      <div className="bg-white rounded-2xl shadow p-4 space-y-6">
        ...
        <button
          ...
          className={`w-50 items-center py-3 rounded-2xl text-white transition ${
            saving || !hasChanges
